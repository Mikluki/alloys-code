...
# base_dir = Path("e-all300k2-ozicar")
# output_decorr = Path("x-all300k2-decorr-poscar")
# output_dir = Path("x-all300k2-analysis")

base_dir = Path("e-Au300k2-ozicar")
output_decorr = Path("x-Au300k2-decorr-poscar")
output_dir = Path("x-Au300k2-analysis")
